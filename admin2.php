        ...
        <div class="page-container">
                ...
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                        <div class="header-wrap">
                            <h1>ABSENSI KARYAWAN NON ASN</h1>
                        </div>
                    </div>
                </div>
            </header>
            ...
            <div class="main-content">
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                        <div class="row">
                            <center><img src="img/dashboard.png" width="500" class="img img-responsive" height="500"></center><br>
                            <strong class="col-md-12" style="margin-top: 5rem;">Selamat datang ! </strong>
                        </div>
                    </div>
                </div>
            </div>
